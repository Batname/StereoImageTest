...
DECLARE_MULTICAST_DELEGATE_OneParam(FPreRenderView_RenderThread, FSceneView&);
...
public:
	/** Keep in track network camera communication */
	bool bIsStart = false;

	FPreRenderView_RenderThread PreRenderView_RenderThread_Delegate;
};
